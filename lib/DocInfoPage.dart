import 'package:khayaal/colorScheme.dart';
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("Dr. Sara Roshni", style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.w400,
                              ),),
                              Text("Heart Homeo Doctor \nCK Hospital", style: TextStyle(
                                fontSize: 17,
                                fontWeight: FontWeight.w400,
                              ),)
                            ],
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(height: 5,),
                            timeSlotWidget("13", "MAY", "Consultation", "Sunday 9 am - 11.30 am"),
                            timeSlotWidget("14", "MAY", "Consultation", "Monday 10 am - 12.30 am"),
                            timeSlotWidget("1", "JUN", "Consultation", "Wednesday 8 am - 12.30 pm"),
                            timeSlotWidget("3", "JUN", "Consultation", "Friday 8 am - 1 am"),
                          ],
                        ),
                      )
                    ],
